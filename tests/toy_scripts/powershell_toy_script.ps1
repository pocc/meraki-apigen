...
# Only barbarians don't use classes in Powershell.
# Without classes, methods have varying and unpredictable behavior for text
# output to the console. Powershell also provides classes with much better
# error checking.
#
# Printing to the console (i.e. checking variables during tests) is considered unreliable.
